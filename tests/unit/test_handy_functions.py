...
from boooks.framework.handy.functions import (
    slugify,
    empty,
    now,
    geo_data_for_ip,
...
@patch('boooks.framework.handy.functions.datetime')
...
@patch('boooks.framework.handy.functions.request')
...
@patch('boooks.framework.handy.functions.PyGEOIP')
