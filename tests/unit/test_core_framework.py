...
from boooks.framework.core import Application, ErrorHandlers


@patch('boooks.framework.core.Flask')
def test_application_has_flask_app(Flask):
    ...
    Flask.assert_called_once_with('boooks.framework.core')
...
@patch('boooks.framework.core.ErrorHandlers')
@patch('boooks.framework.core.Flask')
...
@patch('boooks.framework.core.RedisSessionInterface')
@patch('boooks.framework.core.Flask')
...
@patch('boooks.framework.core.AssetsManager')
@patch('boooks.framework.core.Flask')
...
@patch('boooks.framework.core.Manager')
@patch('boooks.framework.core.Flask')
...
@patch('boooks.framework.core.log')
@patch('boooks.framework.core.Flask')
...
@patch('boooks.framework.core.os')
@patch('boooks.framework.core.RedisSessionInterface')
@patch('boooks.framework.core.Flask')
...
@patch('boooks.framework.core.render_template')
