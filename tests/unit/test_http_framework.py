...
@patch('boooks.framework.http.settings')
...
@patch('boooks.framework.http.request')
...
@patch('boooks.framework.http.set_cors_into_headers')
@patch('boooks.framework.http.json_response')
...
@patch('boooks.framework.http.current_app')
@patch('boooks.framework.http.set_cors_into_headers')
...
@patch('boooks.framework.http.set_cors_into_headers')
@patch('boooks.framework.http.Response')
@patch('boooks.framework.http.json')
...
@patch('boooks.framework.http.request')
@patch('boooks.framework.http.traceback')
@patch('boooks.framework.http.logger')
