...
from boooks.framework.log import (
    ColorFormatter,
...
@patch('boooks.framework.log.settings')
@patch('boooks.framework.log.logging')
...
@patch('boooks.framework.log.settings')
@patch('boooks.framework.log.logging')
@patch('boooks.framework.log.ColorFormatter')
...
@patch('boooks.framework.log.logging')
@patch('boooks.framework.log.datetime')
