...
from boooks.framework.formats.json import json_converter, loads, dumps
...
@patch('boooks.framework.formats.json.json')
...
@patch('boooks.framework.formats.json.json')
@patch('boooks.framework.formats.json.json_converter')
