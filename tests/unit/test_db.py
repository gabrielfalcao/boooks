...
@patch('boooks.framework.db.partial')
...
@patch('boooks.framework.db.StrictRedis')
...
@patch('boooks.framework.db.engine')
...
@patch('boooks.framework.db.nacl.utils.random')
@patch('boooks.framework.db.nacl.secret.SecretBox')
...
@patch('boooks.framework.db.Manager.from_result_proxy')
...
@patch('boooks.framework.db.Manager.get_connection')
@patch('boooks.framework.db.Manager.many_from_result_proxy')
