...
class Application(object):
    ...
    Welcome to the Boooks Application!
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

    This class is the backbone of the Boooks application: it knows
    ...
    def __init__(self, settings_path='boooks.settings', *args, **kwargs):
        self.assets = None
    ...
    def from_env(CreateApplication,
                 environment_variable_name='BOOOKS_SETTINGS_MODULE',
                 fallback_module_name='boooks.settings',
                 *flask_args,
                 **flask_kwargs):
